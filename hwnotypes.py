...
class PancakeState:
    ...
    def __init__(self, pancakes: List[Pancake], is_astar: bool = False):
        """
    ...
    def clone(self, explored_override: bool = False):
        """
    ...
    def generate_possible_moves(self, parent=None):
        """
...
class StateGraph:
    ...
    def __init__(self, state: PancakeState, algorithm: Algorithm) -> None:
        """
    ...
    def generate_tiebreaker_str(self, state: PancakeState) -> int:
        """
    ...
    def order_nodes_by_astar_fn(self, state: List[PancakeState]) -> List[PancakeState]:
        """
    ...
    def bfs_algorithm(self) -> PancakeState:
        """
    ...
    def astar_algorithm(self) -> PancakeState:
        """
...
class PancakeFlippingSolver:
    ...
    def stringify_astar_steps(self, state: PancakeState) -> str:
        """
    ...
    def stringify_steps(self, state: PancakeState) -> str:
        """
...
def main(run_input: bool = True):
    ...
    if run_input:
        ...
        if solver.algorithm != Algorithm.A_STAR:
            steps = solver.stringify_steps(last_step)  # type: ignore
            print(steps)
        else:
            steps = solver.stringify_astar_steps(last_step)  # type: ignore
            print(steps)
    else:
        tester = TestCase()
